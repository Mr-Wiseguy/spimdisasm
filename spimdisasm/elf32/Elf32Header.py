...
class Elf32Identifier:
    ...
    def getFileClass(self) -> Elf32Constants.FileClass:
        return Elf32Constants.FileClass(self.ident[4])

    def getDataEncoding(self) -> Elf32Constants.DataEncoding:
        return Elf32Constants.DataEncoding(self.ident[5])

    def getVersion(self) -> int:
        return self.ident[6]

    def getOsAbi(self) -> Elf32Constants.OsAbi:
        return Elf32Constants.OsAbi(self.ident[7])
    ...
    def fromBytearray(array_of_bytes: bytes, offset: int = 0) -> Elf32Identifier:
        ...
        if identifier.getFileClass() != Elf32Constants.FileClass.CLASS32:
